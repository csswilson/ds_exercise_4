...
starbucks_with_2018_pop_est %>% 
  ...
  theme_map() +
  labs(title = "Number of Starbucks per 10,000 People by U.S State", fill = "Starbucks") +
...
favorite_stp_by_claire <- tibble(
  place = c("Macalester College", "Pad Thai", 
             "Home", "Ordway","Memory Lanes", 
            "Ding Tea", "Science Museum", "Bde Maka Ska",
            "Unommon Grounds", "Como Park", "Mall of America", "Valleyfair "),
  long = c( -93.1712321, -93.171232, 
             -93.164144,-93.029412, -93.236361,
            -93.156294, -93.100313, -93.3113392,
           -93.298021, -93.154338,-93.241244917, -93.453616),
  lat = c( 44.9378965, 44.9409029,
            44.94728, 44.81194547, 44.9825092,
           44.95649455, 44.94453689, 44.9456889,
          44.951775, 44.980273, 44.85684, 44.7988948),
  fave = c( "No", "No",
           "Yes", "No", "Yes",
           "No", "No", "No",
          "No", "No", "No", "Yes")
...
```{r}
factpal <- colorFactor(c("purple", "darkblue"), favorite_stp_by_claire$fave)
